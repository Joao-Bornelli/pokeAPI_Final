...
public class FragmentPokemon extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView pokeHeight = view.findViewById(R.id.pokeHeight);
        TextView pokeWeight = view.findViewById(R.id.pokeWeight);

        pokeName.setText(pokemonPOJO.name);
        pokeHeight.setText("Altura: " + pokemonPOJO.height);
        pokeWeight.setText("Peso: " + pokemonPOJO.weight);
        //
